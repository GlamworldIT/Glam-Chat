...
import 'package:glam_chat/Models/user.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:glam_chat/Pages/ChattingPage.dart';
import 'package:glam_chat/Pages/AccountSettingsPage.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  final String currentUserId;
  bool isLoading = true, isSearch = false;
  String searchQuery = "";
  ...
  Future getAllUser() async {
    Future<QuerySnapshot> allFoundUsers = Firestore.instance
        ...
        .getDocuments();
    setState(() {
      allUser = allFoundUsers;
      isLoading =false;
    });
  }

  Future getSearchedUser() async {
    Future<QuerySnapshot> allFoundUsers = Firestore.instance
        .collection("users")
  ...
  Widget mainList() {
    return allUser == null? noDataFoundMgs() : FutureBuilder(
      future: allUser,
        ...
        child: Column(
          children: [
            GestureDetector(
              ...
              child: ListTile(
                leading: eachUser.photoUrl==null? CircleAvatar(
                ...
                subtitle: Text(
                  "joined: " +
                      DateFormat("dd-MMM-yy, hh:mm:aa").format(
